"""Execute Blind Sealed Re-Acceptance Audit for ERABI Release Candidate 2.
...
- Outputs release/rc2/blind_reacceptance_report.json.
...
logger = logging.getLogger("erabi.rc2_blind_reacceptance")
...
BLIND_TEST_PATH = ROOT / "data/sealed_acceptance_rc2_blind_v2/sealed_test_rc2_blind_v2.jsonl"
REPORT_PATH = RC2_DIR / "blind_reacceptance_report.json"
...
def run_reacceptance():
    logger.info("=== Starting Milestone 24.1: ERABI RC2 Blind Sealed Re-Acceptance Audit ===")
    ...
    # 8. Build Report
    report = {
        "milestone": "Milestone 24.1 — Blind Sealed Re-Acceptance",
    ...
    lines = [
        ...
        f"**Blind Test Suite**: `data/sealed_acceptance_rc2_blind_v2/sealed_test_rc2_blind_v2.jsonl` (480 cases, 240 pairs)  ",
        f"**Pre-Commit Manifesto**: [`BLIND_ACCEPTANCE_PRECOMMIT.md`](file:///f:/ai/erabi-local/BLIND_ACCEPTANCE_PRECOMMIT.md)  ",
    ...
    lines.extend([
        ...
        "",
        "1. **Pre-Commit Isolation**: The blind test suite was finalized, verified for zero leakage against all 48,964 background records, and committed to Git (`6f716e9`) before this execution.",

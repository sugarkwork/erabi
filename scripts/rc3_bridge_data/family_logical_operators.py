...
def get_logical_operators_pairs() -> List[Dict[str, Any]]:
    ...
    k2_defs = [
        (
            ...
            "論理ルール：『主系統バスAまたは副系統バスBの少なくとも一方が正常（OR）』のとき『航空機運航継続承認』、両方途絶なら『緊急代替航法トリップ』。指示せよ。",
        ...
        (
            ...
            "論理ルール：『第1扉または第2扉のどちらか一方のみが開扉（XOR）』のときは『気圧差換気制御を作動』、両方開扉または両方閉止なら『通常換気維持』。判定せよ。",
        ...
        (
            ...
            "論理ルール：『光検出器と音響センサーの双方が非検知（NOR）』でない限り『燃焼安定継続と判定』、双方が非検知のときのみ『失火トリップ実行』。決定せよ。",
        ...
        (
            ...
            "論理ルール：『ゾーン1もゾーン2も共に漏洩未検知（NOR：否定論理和）』のときは『作業者入室安全ランプ点灯』、何らかの検知があれば『入室禁止警報』。判定せよ。",
        ...
        (
            ...
            "論理ルール：『バンパー接触かつレーザースキャナー検知の双方が成立（AND）』のときのみ『緊急メカニカルブレーキ停止』、それ以外なら『通常走行制御継続』。指示せよ。",
        ...
        (
            ...
            "論理ルール：『母線電圧未確立（NOT A）または保護継電器ロック作動（B）』のとき『遮断器投入禁止インターロック』、そうでなければ『投入許可承認』。判定せよ。",
        ...
        (
            ...
            "論理ルール：『単眼カメラとミリ波レーダーの双方が一致して歩行者検出（AND）』のときのみ『緊急自動ブレーキを作動』、不一致または非検出なら『ブレーキ作動保留』。指示せよ。",
        ...
        (
            ...
            "論理ルール：『乾燥時間未了（NOT A）または復圧弁開放（B）』のときは『真空ポンプ排気継続』、そうでなければ『排気ポンプ停止ステップ』。判定せよ。",
        ...
        (
            ...
            "論理ルール：『バルブ未閉止（NOT A）または位置リミット超過（B）』のときは『離脱インターロック施錠』、両方正常なら『離脱待機解除』。決定せよ。",
        ...
        (
            ...
            "論理ルール：『油圧低下警報または過負荷トルクのいずれかが発生（OR）』したときは『送り軸即時非常停止』、未発生なら『通常加工維持』。判定せよ。",
        ...
        (
            ...
            "論理ルール：『15m/s超過かつ責任者中止指示の双方が成立（AND）』のときのみ『クレーン作業避難命令』、そうでなければ『安全配慮通常監視』。判定せよ。",
        ...
        (
            ...
            "論理ルール：『第1セル過充電と第2セル過充電の不一致（XOR）』のときは『個別セル診断モードへ移行』、一致しているときは『一括遮断判定へ移行』。指示せよ。",
            "論理ルール：『第1セル過充電かつ第2セル過充電（AND）』のときは『充電コンタクタ即時遮断トリップ』、両方未検知なら『定電流充電継続』。指示せよ。",
            [("bms_individual_diag", "個別セル診断モードへ移行"), ("bms_master_trip", "充電コンタクタ即時遮断トリップ")],
            "bms_master_trip", "bms_master_trip"
        ),
        (
            "14",
            "半導体クリーンルーム排気スクラバー：酸性排気中和液循環ポンプ作動は作動中（True）、pH中和不全警報は発生中（True）。",
            "論理ルール：『ポンプ作動中かつpH中和不全警報（A AND B）』のときは『中和薬液緊急追加注入ポンプを起動』、警報未発生なら『標準薬液注入維持』。指示せよ。",
            "論理ルール：『ポンプ停止（NOT A）または中和不全警報発生（B）』のときは『スクラバー系統警報を発報』、正常なら『通常運用継続』。指示せよ。",
        ...
        (
            ...
            "論理ルール：『非常口開放も通報装置作動も共に未発生（NOR）』のときは『トンネル通行制限なし（青信号）』、いずれか発生時は『進入規制指令』。指示せよ。",

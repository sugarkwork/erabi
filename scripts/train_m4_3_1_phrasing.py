"""Training script for M4.3.1 Priority Phrasing Semantic Repair (W_m4_3p_fix).
...
Saves best checkpoint to runs/m4_3_1_phrasing_fix/trained/checkpoint.
...
logger = logging.getLogger("erabi.train_m4_3_1p")

OUT_DIR = ROOT / "runs/m4_3_1_phrasing_fix/trained"
OUT_DIR.mkdir(parents=True, exist_ok=True)

TRAIN_FILE = ROOT / "data/m4_3_1_phrasing_fix/combined_train.jsonl"
